...
<form id="form1"
	...
	<table width="100%" border="0" align="left" cellspacing="0"
			...
			<td width="100" class="inputText">&nbsp;&nbsp;技术方向:&nbsp;&nbsp;<select
				...
				style="color: red" onblur="checktech_id()">
					...
					<c:forEach items="${requestScope.techlist}" var="tech">
						<c:if test="${tech.tech_id == requestScope.coursesys.tech_id}">
							<option value="${tech.tech_id}" selected>${tech.tech_tname}</option>
						</c:if>
						<c:if test="${tech.tech_id != requestScope.coursesys.tech_id}">
		...
		<tr align="center">
			<td width="100" height="30" class="inputText">课程体系名称:<input
				...
				class="{required:true}" maxlength="16" value="${requestScope.coursesys.coursesys_csname}"
	...
	<input type="hidden" id="coursesys_csid" name="coursesys_csid"
		value="${requestScope.coursesys_csid}" />
</form>
</body>
</html>