...
<form action="<%=basePath%>departmentControl/updateDepartment.action"
	...
	<table width="100%" border="0" align="left" cellspacing="0"
			...
			<td width="100" class="inputText"><select id="area_id"
				name="area_id" class="{required:true}" style="color: red">
					<c:forEach items="${requestScope.arealist}" var="area">
						<c:if test="${area.area_id == requestScope.department.area_id}">
		...
		<tr>
			...
			<td width="100" class="inputText"><input type="text"
				...
				value="${requestScope.department.department_name}" />
		...
		<tr>
			...
			<td width="100" class="inputText"><input type="text"
				id="department_description" name="department_description"
				class="{required:true}" maxlength="16" onblur="checkcode()"
				value="${requestScope.department.department_description}" />
	...
	<input type="hidden" id="department_id" name="department_id"
		value="${requestScope.department.department_id}" />
</form>
</body>
</html>