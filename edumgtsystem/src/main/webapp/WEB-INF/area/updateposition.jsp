...
<form action="<%=basePath%>positionControl/updatePosition.action"
			...
			<td width="100" class="inputText"><select id="area_id"
				name="area_id" class="{required:true}" style="color: red">
					...
					<c:forEach items="${requestScope.areaList}" var="area">
						<c:if test="${area.area_id == position.area_id}">
				...
				<div id="areanamemsg" style="color: red"></div></td>

		</tr>
		<tr>
			<td width="10" height="30" align="right">所属部门:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td width="100" class="inputText"><select id="department_id"
	...
	<input type="hidden" id="position_id" name="position_id"
		value="${requestScope.position.position_id}" />
</form>
</body>
</html>