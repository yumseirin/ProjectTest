...
<form action="<%=basePath%>areaControl/updateArea.action" method="post"
	id="form1">
	...
	<table width="100%" border="0" align="left" cellspacing="0"
		...
		<tr>
			...
			<td width="100" class="inputText"><input type="text"
				...
				value="${requestScope.area. area_name}" />
		...
		<tr>
			...
			<td width="100" class="inputText"><input type="text"
				...
				value="${requestScope.area. area_code}" />
	...
	<input type="hidden" id="area_id" name="area_id"
		value="${requestScope.area. area_id}" />
</form>
</body>
</html>