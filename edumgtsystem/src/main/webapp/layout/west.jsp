<%@ page language="java" import="java.util.*,com.seirin.vo.sysmgt.Authority" pageEncoding="UTF-8"%>
...
<script type="text/javascript"
   ...
   <c:forEach items="${applicationScope.oneFenlei}"  var="au">
	 ...
	 <div title="${au.AUTHORITY_NAME}" data-options="iconCls:'icon-reload',selected:false"
				style="padding: 10px;">
