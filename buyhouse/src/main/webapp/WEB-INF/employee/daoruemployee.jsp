...
<link href="<%=basePath%>css/right.css" rel="stylesheet" type="text/css" />
	...
	src="<%=basePath%>/js/daoruemployee.js" charset="utf-8"></script>
...
<form id="form1" action="<%=basePath%>DaoRuControl/daoru.action"  method="post" enctype="multipart/form-data">

	<table width="100%" border="0" align="left" cellspacing="0"
		cellpadding="0" bordercolor="red">
		
		<tr align="center">
			<td width="100" height="30">所属区域: 
			<select
			...
			<tr align="center">
			<td width="100" class="inputText">所属部门:
			<select id="employee_dept"
				name="employee_dept" class="{required:true}" style="color: red"  >
				<option value="0">请选择</option>
			</select>
		...
		<tr align="center">
			...
			<span id="position_idmsg" style="color: red"></span>
				...
				<tr align="center">
			<td width="100" height="30" >所属角色:<select
				id="role_id" name="role_id" class="{required:true}"
				style="color: red"   >
				<option value="0">请选择</option>
			...
			<span id="role_idmsg" style="color: red"></span>
			</td>
			</tr>
			<tr align="center">
			<td width="100" class="inputText">技术方向:<select id="employee_tech"
				name="employee_tech" class="{required:true}" style="color: red"  >
				<option value="0">请选择</option>
...
<tr align="center">
		...
		<tr align="center">
			...
			(<a href="<%=basePath%>file/employee.xlsx">模板下载</a>,请上传.xlsx文件)
				</td>
     </tr>
		<tr align="center">
