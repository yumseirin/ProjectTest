...
<form action="<%=basePath%>roleControl/addRoleAuthority.action"
	...
	<table width="100%" border="0" align="left" cellspacing="0"
		...
		<tr>
			...
			<td width="100" class="inputText"><input type="text"
				id="role_name" name="role_name" class="{required:true}"
				maxlength="16" onblur="checkrolename()" />
				<div id="rolenamemsg" style="color: red"></div></td>

		</tr>
		<tr>
			<td width="10" height="30" align="right">状&nbsp;&nbsp;态:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td width="100" class="inputText"><select id="role_state"
				name="role_state" class="{required:true}" style="color: red">
		...
		<tr>
			<td width="10" height="30" align="right">
				角色权限:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td width="100" class="inputText"><select id="role_quanxian"
				name="role_quanxian" style="width: 200px;"></select>
